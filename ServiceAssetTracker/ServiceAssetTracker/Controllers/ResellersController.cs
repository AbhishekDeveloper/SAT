...
namespace ServiceAssetTracker.Controllers
{
    public class ResellersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ResellerId,TradingName,Address1,Address2,City,ContractName,Email,Phone,CreatedOn,Status")] Reseller reseller)
        {
